...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().street(DEFAULT_STREET).zip(DEFAULT_ZIP).city(DEFAULT_CITY);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().street(UPDATED_STREET).zip(UPDATED_ZIP).city(UPDATED_CITY);
        return address;
    }
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.street(UPDATED_STREET).zip(UPDATED_ZIP).city(UPDATED_CITY);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.zip(UPDATED_ZIP).city(UPDATED_CITY);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.street(UPDATED_STREET).zip(UPDATED_ZIP).city(UPDATED_CITY);
