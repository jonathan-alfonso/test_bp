...
class PersonResourceIT {
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().first_name(DEFAULT_FIRST_NAME).last_name(DEFAULT_LAST_NAME).age(DEFAULT_AGE);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().first_name(UPDATED_FIRST_NAME).last_name(UPDATED_LAST_NAME).age(UPDATED_AGE);
        return person;
    }
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.first_name(UPDATED_FIRST_NAME).last_name(UPDATED_LAST_NAME).age(UPDATED_AGE);
    ...
    void partialUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.age(UPDATED_AGE);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.first_name(UPDATED_FIRST_NAME).last_name(UPDATED_LAST_NAME).age(UPDATED_AGE);
